...
public class MaxEmeraldCostFunction implements RequirementFunction<EmeraldCurrencyRequirement, RequirementRegistry.IntParameter> {
    @Override
    public ResourceLocation getId() {
        return WaystoneEmeralds.waystonesId("max_emerald_cost");
    }
    ...
    public EmeraldCurrencyRequirement apply(EmeraldCurrencyRequirement requirement, WarpRequirementsContext context, RequirementRegistry.IntParameter parameter) {
        requirement.setEmeralds(Math.min(requirement.getEmeralds(), parameter.value()));
        return requirement;
    }
}
