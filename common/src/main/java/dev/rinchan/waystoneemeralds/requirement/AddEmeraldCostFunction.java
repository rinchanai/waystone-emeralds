...
public class AddEmeraldCostFunction implements RequirementFunction<EmeraldCurrencyRequirement, RequirementRegistry.IntParameter> {
    @Override
    public ResourceLocation getId() {
        return WaystoneEmeralds.waystonesId("add_emerald_cost");
    }
    ...
    public EmeraldCurrencyRequirement apply(EmeraldCurrencyRequirement requirement, WarpRequirementsContext context, RequirementRegistry.IntParameter parameter) {
        requirement.setEmeralds(requirement.getEmeralds() + parameter.value());
        return requirement;
    }
}
